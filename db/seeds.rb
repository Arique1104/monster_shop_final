...
arique = Merchant.create!(name: "Arique's Thought Shop", address: "1234 Division St.", city: "Chicago", state: "IL", zip: 60651)
    ...
    arique.bulk_discounts.create!(name: "You Deserve It", percent_discount: 75, min_purchase: 8, active: true)
    arique.bulk_discounts.create!(name: "For someone You Care For", percent_discount: 50, min_purchase: 7, active: true)
...
getulio = Merchant.create!(name: "Getulio's Lock Shop", address: "9087 Armitage St.", city: "Chicago", state: "IL", zip: 60647)
    ...
    getulio.bulk_discounts.create!(name: "Don't get locked out", percent_discount: 10, min_purchase: 10, active: true)
...
lasondra = Merchant.create!(name: "Lasondra's Art Shop", address: "3456 South Side Street", city: "Chicago", state: "IL", zip: 60606)
    ...
    lasondra.bulk_discounts.create!(name: "Try it!  You deserve it!", percent_discount: 10, min_purchase: 1, active: true)
...
ed = Merchant.create!(name: "Ed's Golf Shop", address: "12345 Caring Ave", city: "Raleigh", state: "NC", zip: 27601)
    ...
    ed.bulk_discounts.create!(name: "Try it!  You deserve it!", percent_discount: 10, min_purchase: 1, active: true)
...
priya = Merchant.create!(name: "Priya's Personal Power Inc.", address: "1234 Shine", city: "Denver", state: "CO", zip: 80016)
    ...
    priya.bulk_discounts.create!(name: "Try it!  You deserve it!", percent_discount: 10, min_purchase: 1, active: true)
